...
final class TalkProtocolService
{
    public function next(int $tenantId,?int $condominiumId=null): string
    {
        ...
        try{
            ...
            $number=str_pad((string)$sequence,$digits,'0',STR_PAD_LEFT);$identified=$condominiumId!==null&&$condominiumId>0;$prefix=$identified?$configuredPrefix:'TK';$scope=$identified?(string)$condominiumId:'00';$protocol=$prefix.'-'.$year.'-'.$number.'-'.$scope;$pdo->commit();return $protocol;
