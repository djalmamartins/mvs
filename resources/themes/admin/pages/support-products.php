...
<section class="studio-page support-knowledge-page" data-knowledge-page="products">
    <header class="studio-page-heading">
        <div>
            ...
            <h2>Produtos</h2>
            <p>Organize os produtos atendidos pela base de conhecimento.</p>
        </div>
        <button class="studio-btn primary" type="button" data-knowledge-open="product">Novo produto</button>
    </header>
    <nav class="support-knowledge-tabs" aria-label="Base de conhecimento">
        <a href="/support/articles">Artigos</a><a href="/support/categories">Categorias</a>
        <a class="active" href="/support/products">Produtos</a><a href="/support/tags">Tags</a>
    </nav>
