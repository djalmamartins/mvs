<?php declare(strict_types=1); $this->layout('layouts/default', ['title'=>$title,'currentPage'=>'trash']); $labels=['page'=>'Página','project'=>'Projeto','article'=>'Artigo','highlight'=>'Destaque','testimonial'=>'Depoimento','faq'=>'FAQ']; ?>
