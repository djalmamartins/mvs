...
<section class="studio-dashboard-actions studio-panel-body"><p class="studio-eyebrow">Ações rápidas</p><div class="studio-actions"><a class="studio-btn primary" href="/admin/pages?create=1">Nova página</a><a class="studio-btn" href="/admin/articles?create=1">Novo artigo</a><a class="studio-btn" href="/admin/highlights?create=1">Novo destaque</a><a class="studio-btn" href="/admin/faq">Perguntas frequentes</a><a class="studio-btn" href="/admin/proposals">Propostas recebidas</a><a class="studio-btn" href="/admin/settings">Configurações</a></div></section>
