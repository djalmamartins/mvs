...
<section class="studio-page">
    ...
    <form class="studio-filter-bar" method="get" action="/studio/logs">
        ...
        <button type="submit">Filtrar</button><a href="/studio/logs">Limpar</a>
    </form>
    <?php if ($entries === []): ?>
