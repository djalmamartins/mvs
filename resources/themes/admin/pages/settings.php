...
<section class="studio-page">
    <header class="studio-page-heading"><div><p class="studio-eyebrow">SISTEMA</p><h2><?= $this->e($title) ?></h2><p>Controle a identidade, comunicação, aparência e os módulos do MovesOS.</p></div><div class="studio-actions"><a class="studio-btn" href="/admin/versions"><?= studio_icon('tag') ?> Versões</a><a class="studio-btn" href="/" target="_blank" rel="noopener"><?= studio_icon('external-link') ?> Ver site</a></div></header>
