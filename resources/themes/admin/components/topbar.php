    ...
    <nav class="studio-header-actions" aria-label="Atalhos do painel">
        ...
        <div class="studio-notifications">
            ...
            <section class="studio-notification-panel" id="studio-notification-panel" role="dialog" aria-label="Notificações">
                <header><div><strong>Notificações</strong><small><?= $unreadNotifications ? $unreadNotifications.' não lidas' : 'Tudo em dia' ?></small></div><?php if (Access::can('notifications.manage')): ?><a href="/studio/notifications">Ver todas</a><?php endif; ?></header>
