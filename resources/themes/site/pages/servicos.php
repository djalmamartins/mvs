...
<section class="section-shell service-fold" id="criacao-de-sites">
    ...
    <div class="service-fold-copy"><p class="eyebrow">01 / CRIAÇÃO DE SITES</p><h2>Sua marca merece uma<br><span class="brand-gradient">presença à altura.</span></h2><p>Sites institucionais e landing pages que apresentam seu negócio com clareza e ajudam o visitante a dar o próximo passo.</p><ul><li>Arquitetura de informação e organização do conteúdo</li><li>Design responsivo para celular, tablet e computador</li><li>Desenvolvimento com atenção a desempenho e acessibilidade</li><li>Estrutura técnica para indexação em buscadores</li></ul><a class="text-link" href="mailto:contato@moves.com.br?subject=Criação%20de%20sites">Conversar sobre criação de sites ↗</a></div>
</section>
...
<section class="section-shell service-fold" id="aplicativos">
    ...
    <div class="service-fold-copy"><p class="eyebrow">03 / APLICATIVOS</p><h2>Sua ideia, mais perto<br><span class="brand-gradient">das pessoas.</span></h2><p>Planejamos experiências para dispositivos móveis com foco nos fluxos que o seu público precisa realizar.</p><ul><li>Definição do produto e público</li><li>Protótipos dos principais fluxos</li><li>Desenvolvimento e integrações conforme o escopo</li><li>Preparação para distribuição e evolução</li></ul><a class="text-link" href="mailto:contato@moves.com.br?subject=Aplicativos">Conversar sobre aplicativos ↗</a></div>
</section>
...
<section class="section-shell service-fold" id="hospedagem">
    ...
    <div class="service-fold-copy"><p class="eyebrow">04 / HOSPEDAGEM</p><h2>Uma base para sua<br><span class="brand-gradient">presença digital.</span></h2><p>Planejamos o ambiente de hospedagem de acordo com as necessidades técnicas do seu site e da sua operação.</p><ul><li>Análise dos requisitos do site</li><li>Orientação sobre domínio e certificado</li><li>Configuração de ambiente conforme a proposta</li><li>Definição de rotinas de atualização e cópias de segurança</li></ul><a class="text-link" href="mailto:contato@moves.com.br?subject=Hospedagem">Conversar sobre hospedagem ↗</a></div>
</section>
